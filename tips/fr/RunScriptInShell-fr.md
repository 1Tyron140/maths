Dans ce fichier je vais expliquer comment utiliser l'invite de commande (shell) python plus rapidement, j'utilise une casio 90+e mais ca devrait fonctionner pour tous.
...
*Cette ligne nous dit que toutes les fonctions du programmes ont été importées (la fonction hello() dans ce cas)*
...
*Je peux donc utiliser les fonctions du programmes en les recrivant dans la dernière ligne du shell*
...
Hello world a bien été affiché

*En remontant avec le flèches dans les autres lignes, on peut copier coller une ligne surlignée avec exe ou enter selon le modèle de calculatrice*

![copie](https://github.com/1Tyron140/maths/blob/main/images/screenshots/RunScriptInShell_6.png?raw=true "copié")

*pour les exemples suivants j'ai copié les lignes plus haut, la capture d'écran représentent les copies dans la dernière ligne du shell*
...
Voila maintenant vous pourrez aller plus vite dans le shell en copiant la ligne sélectionnée avec exe(ou enter) et executer la ligne sans avoir a réecrire la fonction à la main.
